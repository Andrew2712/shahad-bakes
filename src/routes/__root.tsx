...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Premium healthy bakery. No sugar, no flour, no refined oil. Freshly baked cookies, cakes, brownies and celebration cakes." },
      { property: "og:title", content: "Shahad Bakes — Healthy Sweetness Without Guilt" },
      { property: "og:description", content: "Premium healthy bakery. No sugar, no flour, no refined oil." },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Playfair+Display:wght@500;600;700&family=Inter:wght@300;400;500;600&family=Montserrat:wght@400;500;600&display=swap" },
    ],
  }),
